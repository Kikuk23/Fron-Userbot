...
async def _(event):
    ...
    if input_str == "owner":
        ...
        animation_chars = [
            "**OWNER FRON-USERBOT ADALAH MANUSIA TERGANTENG DI HATI PEMAKAI NYA, KENALAN DULU SAMA OWNER NYA YUK**"
            "**HUFRON NAMANYA,ORANG NYA BAIK**"
            "**TINGGAL NYA DI KALIDERES, BTW ORANG KALIDERES GANTENG GANTENG DAN THEBEST POKOK NYA AWWHHHH**"
